  ...
  return (
    <Dialog open={open} onOpenChange={v => !v && onClose()}>
      <DialogContent className="max-w-lg max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>Mitarbeiterverwaltung anzeigen</DialogTitle>
        </DialogHeader>
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-1">
            <Label className="text-xs text-muted-foreground">Abteilung / Team</Label>
          ...
          <div className="space-y-1">
            <Label className="text-xs text-muted-foreground">Handy-Nummer</Label>
            <p className="text-sm">{record.fields.handy ?? '—'}</p>
          </div>
          <div className="space-y-1">
