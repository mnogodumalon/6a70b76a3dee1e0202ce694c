...
// <custom:intent-imports>
import { IconToolsOff, IconPackageImport } from '@tabler/icons-react';
// </custom:intent-imports>
...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/werkzeug-ausleihen', label: 'Werkzeug ausleihen', icon: IconToolsOff, description: 'Werkzeug an Mitarbeiter ausleihen' },
  { path: '/intents/werkzeug-rueckgabe', label: 'Werkzeug zurückgeben', icon: IconPackageImport, description: 'Rückgabe erfassen und Wartung einplanen' },
  // </custom:intents>
];
