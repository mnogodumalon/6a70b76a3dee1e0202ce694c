// Auto-generated. Per-entity form-enhancements config for "Ausleihe & Rückgabe".
...
export const formEnhancements: FormEnhancements = {
  ...
  defaults: {
    ...
    'geplante_rueckgabe': { kind: 'todayOffset', days: 3 },
    'status': { kind: 'lookup', key: 'ausgeliehen', label: 'Ausgeliehen' },
  },
  computed: {
    '_ausleihe_dauer_tage': { kind: 'dateDiff', from: 'ausleihdatum', to: 'geplante_rueckgabe', unit: 'days' },
  },
};
